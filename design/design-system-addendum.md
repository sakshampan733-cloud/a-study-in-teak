...
| Wordmark in Pragmatica Cond 32px | The wordmark is a heavy **logotype** drawn in SVG, not type; its capitals are ≈19 px and it is exactly as wide as the mark | Ours is type (no logotype exists): condensed **weight 900** — the logo is the one exception to weight 400, as the live logotype is heavy — **stacked on two lines** (the owner's choice: our 15 letters to their 7), capitals ≈19 px, each line about the mark's width (≈90 px); mark to wordmark 29 px ink to ink |

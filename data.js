    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            { label: "Direction", value: "CORRECTED — not structural steel. Full-height doors, plywood core with mica and veneer, built and finished to READ as blackened steel framing (ref. 2) — applied glazing bars, painted/lacquered black — with white textured glass in lead came on ONE bay per run only (see Glass bay below); the rest are solid mica/veneer fronts. Lit from inside where glazed (ref. 1). Brass bar pulls. Actual steel is hardware only — the fold-slide track." },
            ...
            { label: "Frames", value: "Ply/mica/veneer construction, finished black to read as steel T-section (38 mm face), transom bar at 560 below the cornice (as ref. 2) — not actual metal fabrication." },
            ...
            { label: "Glass bay", value: "Only ONE bay per run is glazed like ref. 2 — the rest are solid mica/veneer fronts. Recommended: the MIDDLE bay of each run, clear of the fold-slide mechanism at the end bays and away from the D3 door. Left wall: bay 2 of 3. Right wall: bay 2 or 3 of 4 — pick whichever reads best walking in. Interior of the glass bay lit warm and finished in the ivory/cream matte linen already chosen (ref. 1) — confirmed again by the owner's own reference photo." },
            { label: "Dimensions", value: "Two runs, 2 ft 3 in deep and 9 ft 0 in tall — the ceiling is plain on both these walls (9 ft 1 in; the dome is over the middle and does not reach them). The 2 ft 3 in is what lets the right-hand run reach the bedroom wall: the door frame stands 2 ft 4 in off that corner, so the run clears it by 1 in. Each wall is divided into equal bays, so nothing is left over: the right wall is 12 ft 4 in over 4 bays, the left 9 ft 4 in over 3, both coming out at about 3 ft 1 in. Seven bays in all. Each is a pair of doors with a pair of opening transom lights over, so the transom stores too — 14 cupboards, 28 leaves. The far bay of the right run is the hidden tunnel door. See AST-DR-025." },
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "Size", value: "CONFIRMED, revised — wider wings. The whole frame, wings angled, fits inside 3 ft 6 in across. Wing GLASS 12 in each (frame about 1 ft 2½ in). Centre glass about 1 ft 5½ in (frame 1 ft 8¾ in) — the trade for the bigger wings. 9 ft tall. It stands about 11¼ in off the wall (was 6½ in, before the wings widened). See AST-DR-027." },
            ...
            { label: "Worth knowing", value: "A 2 ft 3 in centre inside 3 ft 6 in leaves the wings small — about 5¼ in of glass each. A slimmer 1 in frame would take them to about 6¼ in." },
            { label: "Finish", value: "", hint: "Frame finish to sit with the blackened-steel wardrobe frames and brass pulls" },
          ],
          questions: ["The frame finish — dark bronze, blackened steel, or to match the wardrobe frames exactly?"],
        },
      ],
    },
    {

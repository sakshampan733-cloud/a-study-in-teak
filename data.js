    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          drawings: ["rightwall"],
          refs: [
            { src: "assets/refs/rightwall-iter-1-rail-2ft3.jpg", caption: "Iteration 1 — rail at 2 ft 3 in, the study counter carried round the corner. The line crosses the door's lower panel and the panels below it are only 1 ft 1 in tall. Dropped." },
            { src: "assets/refs/rightwall-iter-2-rail-2ft10.jpg", caption: "Iteration 2 — rail lifted to 2 ft 10 in to meet the door's lock rail. Much better panels, but the study counter then arrives at the corner 6¾ in lower. Dropped." },
            { src: "assets/refs/rightwall-iter-3-no-rail-one-panel.jpg", caption: "Iteration 3 — rail deleted and the two panels merged into one, floor to casing crown. Calm, but the wall loses its base and the sconces float. Dropped." },
            { src: "assets/refs/rightwall-iter-4-adopted.jpg", caption: "Iteration 4 — ADOPTED. No rail; two panels split on the door's own lock rail, so the band runs unbroken through the door. This is what AST-DR-007 draws." },

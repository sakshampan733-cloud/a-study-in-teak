      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "References chosen", value: "Ref. 1 (walnut library with red chesterfield): fluted pilasters, large bolection-moulded panel for the painting, cupboard band with projecting top. Ref. 2 (black study with arched bookcases): cornice of carved acanthus modillion blocks over a dentil course, acanthus capitals with volutes, lit arched bookcase head." },
            { label: "Pilasters", value: "Two, flanking the centre panel: 220 wide, 60 proud, 7 stopped flutes, moulded plinth block on the counter, astragal, two-row acanthus capital with volutes and abacus." },
            { label: "Cornice", value: "Full width, 465 deep: stepped architrave, plain frieze, carved acanthus modillion blocks at 115 centres, dentils, cyma crown. Breaks forward over each pilaster." },
            { label: "Bookcase", value: "Open shelves at 300 spacing under a segmental arched head with archivolt, keystone and spandrel panels; warm LED down-light in the arch." },
            { label: "Cupboards", value: "Full-width band 800 high, 450 deep, reeded 40 mm top matching the desk; raised-panel doors with brass drop handles; drawers under the centre panel." },
            ...
            { label: "Window side", value: "Moulded architrave round the window, panelled reveals, panel and keystone over the head, cornice running across; sill level with the counter." },

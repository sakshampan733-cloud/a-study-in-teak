      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "End bays", value: "The bay at the back of each run — nearest the free-standing mirror — does not hinge open like the rest. A hinged double door there would swing about 1 ft 6½ in into the room, but the mirror only leaves about 10½ in of clear floor beside it: it would hit the mirror by roughly 8 in. Both end bays (including the tunnel door) instead FOLD AND SLIDE: the pair of leaves folds flat together at the centre joint, then the folded pair runs sideways on a top track and tucks flush against the wall, beside the next bay — never swinging into the room. Closed, it reads exactly like every other double door. See AST-DR-026." },
          ],
          questions: [
            "How many doors per run, and how much hanging vs drawers behind them?",
            "The fold-slide track needs a slim pocket built into the party frame beside each end bay — confirm that frame can take it, and get the hardware (a telescoping/bypass bifold track) specified by a supplier.",
          ],
        },
        {
          ...
          parts: [
            ...
            { label: "Placement", value: "Centred on the far wall, free-standing — CONFIRMED not fixed to either wardrobe run. It stands clear of both, with about 10½ in of floor either side of it, in the 4 ft 9 in the two runs leave open between them." },
            { label: "Dimensions", value: "3 ft wide overall (folded flat against the wall) × 9 ft tall — the same line as the top of the wardrobes. Centre and wing widths not yet split.", hint: "Height, centre panel width, wing width" },
            { label: "Finish", value: "", hint: "Frame finish to sit with the blackened-steel wardrobe frames and brass pulls" },
          ],
          questions: ["How does the 3 ft split between the centre panel and the two wings?"],
        },
      ],
    },
    {

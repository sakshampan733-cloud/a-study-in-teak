    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          refs: [
            { src: "assets/refs/right-wall-panelling.svg", caption: "Right wall options — A 4 panels / 2 lamps, B 5 panels / 2 lamps (recommended), C 5 panels / 3 lamps, D 3 wide panels / 3 lamps" },
          ...
          parts: [
            ...
            { label: "Length", value: "About 14–15 ft from the study wall to the bathroom door (drawn at 14 ft 6 in), then the door, then 2 ft of wall to the corner" },
            { label: "Heights", value: "Skirting 130 · dado rail on the 610 line, level with the top of the 2 ft study cupboards · tall panels stop 160 below the crown" },
            { label: "Panels", value: "Recommended B: 5 panels about 24 in wide on the long run, short and tall panels on the same centres, plus one narrow panel on the 2 ft wall past the door" },
            { label: "Door", value: "Bathroom door 2 ft 6 in × 8 ft, architrave about 2½ in (65) all round; rail and skirting stop at it" },
            { label: "Lamps", value: "Twin-arm wall lamps centred inside the tall panels at 1290, the same height as the study sconces. Recommended B: 2 lamps in panels 2 and 4 — plain, lamp, plain, lamp, plain" },
            { label: "Lighting", value: "Cove light under the crown, on the room's cove dimmer" },
          ],
          questions: ["Pick an option: A, B, C or D", "Exact length to the bathroom door"],
        },
      ],
    },
    {

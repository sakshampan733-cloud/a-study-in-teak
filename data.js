      ...
      items: [
        {
          ...
          refs: [
            { src: "assets/refs/side-walls-panelling.svg", caption: "Side walls — lower panels end at 610, level with the study cupboards; tall panels above" },
          ...
          parts: [
            ...
            { label: "Heights", value: "Skirting 130 · dado rail top at 655, lower panels finish at 610 to match the 2 ft study cupboards · upper panels stop 160 below the crown" },
            { label: "Bays", value: "5, equal width, lower and upper panels on the same centres" },
            { label: "Ends", value: "Study end: runs into the side of the bookcase. Bed end: stops at the architrave of D1" },
            { label: "Lighting", value: "Cove light under the crown, on the room's cove dimmer" },
            { label: "Veneer", inherit: "veneer" },
            { label: "Polish", inherit: "polish" },
          ],
          questions: ["Exact wall length and D1 position — the board uses plan estimates", "Moulding painted the wall colour, or a shade darker?"],
        },
        {
          id: "right-wall", name: "Right Wall", status: "open",
          refs: [
            { src: "assets/refs/side-walls-panelling.svg", caption: "Side walls — right wall, panels fitted around D2 and D3" },
          ],
          parts: [
            { label: "Treatment", value: "Same panel moulding as the left wall, so the two sides match" },
            { label: "Heights", value: "Same as the left wall — dado at 610 to match the study cupboards" },
            { label: "Bays", value: "4 — two before D2, one between the doors, one after D3" },
            { label: "Ends", value: "Study end: the 2 ft cupboard return, panelling above. Doors: rail and skirting stop at the architraves" },
            { label: "Veneer", inherit: "veneer" },
            { label: "Polish", inherit: "polish" },
          ],
          questions: ["Exact positions of D2 and D3 from the study wall"],
        },
      ],
    },
    {

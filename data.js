    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            { label: "Layout", value: "Left: bookcase with open shelves under a lit arch. Centre: moulded panel (a painting may hang here). Right: the window. Two full-height fluted pilasters, floor to cornice, frame the centre panel. Cupboards run under all three bays." },
            ...
            { label: "References chosen", value: "Ref. 1 (walnut library with red chesterfield): full-height fluted pilasters with plain moulded capitals, moulded painting panel, cupboards below. Ref. 2 (black study with arched bookcases): block-and-dentil cornice (kept plain, no leaf carving), lit arched bookcase head." },
            { label: "Pilasters", value: "Two, 240 wide, 60 proud, floor to cornice: plinth block and torus at the floor, 9 stopped flutes, plain moulded capital (astragal, neck, ovolo, abacus). No carving." },

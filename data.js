    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          drawings: ["vanity", "vanity-b", "vanity-c"],
          parts: [
            ...
            { label: "Carcass & fronts", value: "Teak veneer on 18 BWP / marine ply, every edge sealed; solid teak lipping on the fronts. Hung on a ply cleat on the wall; soft-close undermount runners." },
            { label: "Fittings", value: "Chrome — already bought. Brass and gold were priced out for the bathroom, so this is the one place in the room that breaks from the brass rule. Cup pulls to match." },

      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "Clearing the wall", value: "Because the door is thick, its far corner swings on a bigger circle than the door is wide. Full width (2 ft 11¼ in) it would hit the tunnel's right wall by about 1 in. So the door is 2 ft 9¼ in wide, and a fixed 2¾ in upright fills the rest of the opening on the right — the door closes against it and the touch latch sits on it. Closed, it reads as one more shelf upright. The corner then clears the wall by about ½ in." },
            { label: "What it leaves", value: "Door plus shelves is 11¾ in deep. The tunnel is 3 ft wide, so about 2 ft stays clear to walk through — narrowing to about 1 ft 9½ in for a moment at the mouth, past the fixed upright. The first 2 ft 9¼ in of the left wall, where the door lands, must stay empty — the tunnel's own shelves begin just after it." },
          ],
          questions: [

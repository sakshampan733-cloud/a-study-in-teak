      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "Length", value: "13 ft 6 in from the study wall corner to the door frame, then the 3 ft frame carrying the 2 ft 6 in leaf, then 2 ft 4 in of wall to the dressing corner — 18 ft 11 in overall. The 2 ft 4 in was taped on both sides of the wall, so it is the figure that governs; an earlier 2 ft 9 in had been back-calculated from the overall and was wrong." },
      ...
      items: [
        {
          ...
          parts: [
            { label: "Doorway", value: "The 9 ft 3 in wall is the FRONT wall — shared with the bedroom, nearest the entry — and it carries both doors: D2, the existing door in from the bedroom (already on AST-DR-000), and D3, the bathroom door, further along the same wall. The mirror is on the wall opposite this one, 12 ft 4 in away — not on this wall." },
            { label: "Bathroom door", value: "D3 — 2 ft 6 in wide, on the front wall, left of centre, next to D2. Corrected from an earlier read of 2 ft 3 in. Its exact offset along the wall is read off the sketch by eye, not measured." },
            { label: "Wardrobe walls", value: "Left and right walls take the wardrobes (3 ft wide × 2 ft 4 in deep each, the full 12 ft 4 in depth — see Wardrobes below); the dressing mirror faces them from the back wall." },
            { label: "The tunnel", value: "At the far back-right corner: a full-height cupboard door, built and shelved exactly like the wardrobe doors on the same 2 ft 4 in depth, that is really a hidden door — push it and it swings open onto a tunnel about 7 ft 8 in long and 3 ft wide, projecting past the back wall. From the room it reads as one more cupboard; nobody would guess there is a tunnel behind it." },

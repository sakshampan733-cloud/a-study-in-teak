      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "End bays", value: "The bay at the back of each run — nearest the free-standing mirror — does not hinge open like the rest: a hinged leaf would swing about 1 ft 6½ in into the room, and the mirror leaves only about 10½ in beside it. Both end bays (including the tunnel door) fold INTO the cupboard and push back instead — see End-Bay Doors below, with the video." },
          ],
          questions: [
        ...
        },
        {
          ...
          video: { src: "assets/video/dressing-endbay-foldin.mp4", poster: "assets/video/dressing-endbay-foldin.jpg", caption: "Three ways, one after another. A — folds into the cupboard, parks at the mirror end. B — folds into the cupboard, parks at the front end. C — folds out like the owner's photo, then slides back into the cupboard. Each is shown from the doorway, then close up into the bay, then from above. Red line = the front of the wardrobe." },
          parts: [

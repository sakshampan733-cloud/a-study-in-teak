    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          refs: [
            { src: "assets/refs/right-wall-panelling.svg", caption: "Right wall — 4 bays, dado on the 610 line of the study cupboards, twin lamps, bathroom door at the end" },
          ...
          parts: [
            ...
            { label: "Length", value: "About 14–15 ft from the study wall to the bathroom door (drawn at 14 ft 6 in)" },
            ...
            { label: "Bays", value: "4 equal bays; short and tall panels on the same centres" },
            { label: "Ends", value: "Study end: the 2 ft cupboard return. Bathroom end: rail and skirting stop at the door architrave" },
            { label: "Lamps", value: "Recommended: 2 twin-arm wall lamps on the 1st and 3rd stiles at 1290, the same height as the study sconces. Option: a third on the middle stile" },
            { label: "Lighting", value: "Cove light under the crown, on the room's cove dimmer" },
            { label: "Veneer", inherit: "veneer" },
            { label: "Polish", inherit: "polish" },
          ],
          questions: ["Exact length to the bathroom door", "Two lamps or three?", "Moulding painted the wall colour, or a shade darker?"],
        },
      ],
    },
    {

      ...
      items: [
        {
          ...
          parts: [
            ...
            { label: "Casing", value: "The frame is 2 in on the face; the moulding adds 4 in outside it, so the casing is 6 in all round. The jambs are reeded. Over the opening the head is built up as the brownstone reference — an ovolo, a course of scallops, a plain frieze carried on two carved corbels, a bed mould, and a crown that mitres back at each end rather than dying into the wall. The crown lands at 8 ft 8 in, leaving 5 in of wall to the ceiling." },
            { label: "Blocks", value: "A roundel block interrupts the reeding at 3 ft 1 in, and a plinth block takes the jamb down to the floor, so the casing meets the marble skirting square instead of scribing over it." },
            { label: "Which is carved", value: "Only the dressing door: a palmette cap, a long panel of chevrons, and an interlaced knot at the foot of each corbel. The main and bathroom doors take the identical head with panelled corbels, so the three read as one family with one of them clearly the important one." },
      ...
      items: [
        ...
        },
        {
          ...
          parts: [
            ...
            { label: "Heights", value: "Ceiling 9 ft 1 in (2769). Marble skirting 102 · rail 646–686, the study counter band carried round the corner unbroken · short panels 212–546 · tall panels 796–2631, level with the crown of the door casing · no crown moulding — the cove light is in the ceiling" },
